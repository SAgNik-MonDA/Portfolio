...
import { education } from "../../Constrants"; // Import the education data
...
const Education = () => {
  ...
  <div className="absolute sm:left-1/2 left-0 transform -translate-x-1/2  w-12 h-12  z-10 md:hidden sm:hidden">
            ...
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl   bg-gray-900 backdrop-blur-md shadow-[0_0_20px_5px_rgba(78,209,156,0.3)] border border-[rgb(78,209,156)] ${
