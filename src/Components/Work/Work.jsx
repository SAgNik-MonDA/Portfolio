...
import { project } from "../../Constrants.js";
...
const Work = () => {
  ...
  return (
    <section
      id="work"
      className="py-26 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative bg-skills-gradient"
    >
      {/* Section Title */}
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4 ">
          <div className="bg-gray-900 rounded-xl   w-[80%] max-w-xl overflow-hidden relative border border-[rgb(78,209,156)] shadow-[0_0_20px_5px_rgba(78,209,156,0.3)]">
            ...
            <div className="flex flex-col">
              <div className="w-full flex justify-center bg-gray-900 px-4">
                <img
                  ...
                  className="lg:w-[60%] w-[95%] object-contain rounded-xl shadow-2xl"
                />
              </div>
