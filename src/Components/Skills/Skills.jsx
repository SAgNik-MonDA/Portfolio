...
const Skills = () => (
  <section
    id="skills"
    className="relative -mt-24 pt-12 pb-16 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans bg-skills-gradient clip-path-custom"
  >
    {/* Section Title */}
    ...
    {/* Skill Categories */}
    <div className="flex flex-wrap gap-2 lg:gap-5 py-6 justify-between">
      {SkillsInfo.map((category) => (
        <div
          key={category.title}
          className="
            bg-gray-900 backdrop-blur-md
            px-6 sm:px-10 py-8 sm:py-6 mb-8
            w-full sm:w-[48%]
            rounded-2xl
